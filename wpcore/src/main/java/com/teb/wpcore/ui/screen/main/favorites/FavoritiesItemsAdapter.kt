...
import com.teb.wpcore.ui.screen.main.postitem.PostItemsAdapter
import com.teb.wpcore.ui.util.loadUrl

class FavoritiesItemsAdapter: RecyclerView.Adapter<FavoritiesItemsAdapter.PostItemViewHolder>() {
