...
import com.teb.wordpressapp.databinding.ListItemCategotyBinding
...
class CategoriesAdapter : RecyclerView.Adapter<CategoriesAdapter.CategoriesViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): CategoriesViewHolder {
        ...
        val binding =
            ListItemCategotyBinding.inflate(LayoutInflater.from(parent.context), parent, false)
    ...
    inner class CategoriesViewHolder(var binding: ListItemCategotyBinding) :
